...
public class PprbMockService extends CommonMockService implements MessageProcessor {
  ...
  private SrvGetOperatorInfoByUserRs getResponse(SrvGetOperatorInfoByUserRq request) {
    ...
    SrvGetOperatorInfoByUserRsMessage.OperatorInfoItem operatorInfoItem = null;
  ...
  private SrvGetOperatorInfoByIdRs getResponse(SrvGetOperatorInfoByIdRq request) {
    SrvGetOperatorInfoByIdRs response = new SrvGetOperatorInfoByIdRs();
    response.setHeaderInfo(copyHeaderInfo(request.getHeaderInfo()));
    response.setSrvGetOperatorInfoByIdRsMessage(new SrvGetOperatorInfoByIdRsMessage());
    SrvGetOperatorInfoByIdRsMessage.OperatorInfoItem operatorInfoItem = null;
    operatorInfoItem = getOperatorInfoItem2("CB4F526A9F53406799ADDA94B1108310",
        "Иванов Иван Иванович", "ivanov@test.com");
    response.getSrvGetOperatorInfoByIdRsMessage().setOperatorInfoItem(operatorInfoItem);
    return response;
  }
  ...
  private SrvGetOperatorInfoByUserRsMessage.OperatorInfoItem getOperatorInfoItem(
      String workPlaceUId, String fullName, String email) {
    SrvGetOperatorInfoByUserRsMessage.OperatorInfoItem operatorInfoItem =
        new SrvGetOperatorInfoByUserRsMessage.OperatorInfoItem();
  ...
  private SrvGetOperatorInfoByIdRsMessage.OperatorInfoItem getOperatorInfoItem2(
      String workPlaceUId, String fullName, String email) {
    SrvGetOperatorInfoByIdRsMessage.OperatorInfoItem operatorInfoItem =
        new SrvGetOperatorInfoByIdRsMessage.OperatorInfoItem();
    operatorInfoItem.setWorkPlaceUId(workPlaceUId);
    operatorInfoItem.setOperatorFullName(fullName);
    operatorInfoItem.setSubbranchInfoItem(getSubbranchInfoItem2());
    String[] fio = fullName.split("\\s");
    if (fio.length == 3) {
      operatorInfoItem.setFirstName(fio[1]);
      operatorInfoItem.setLastName(fio[0]);
  ...
  private SrvGetOperatorInfoByUserRsMessage.OperatorInfoItem.SubbranchInfoItem
      getSubbranchInfoItem() {
    SrvGetOperatorInfoByUserRsMessage.OperatorInfoItem.SubbranchInfoItem subbranchInfoItem =
        new SrvGetOperatorInfoByUserRsMessage.OperatorInfoItem.SubbranchInfoItem();
  ...
  private SrvGetOperatorInfoByIdRsMessage.OperatorInfoItem.SubbranchInfoItem
      getSubbranchInfoItem2() {
    SrvGetOperatorInfoByIdRsMessage.OperatorInfoItem.SubbranchInfoItem subbranchInfoItem =
        new SrvGetOperatorInfoByIdRsMessage.OperatorInfoItem.SubbranchInfoItem();
    subbranchInfoItem.setTBCode("13");
    subbranchInfoItem.setGOSBCode("8593");
    subbranchInfoItem.setOSBCode(null);
    subbranchInfoItem.setVSPCode("0102");
